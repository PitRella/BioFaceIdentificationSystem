...
Вы можете протестировать полный цикл работы:
1. Зарегистрировать пользователя через `scripts/register_user.py`
2. Идентифицировать пользователя через `scripts/identify_user.py`
